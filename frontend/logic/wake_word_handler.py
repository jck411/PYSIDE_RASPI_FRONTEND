...
class WakeWordHandler:
    def __init__(self):
        ...
        self.done = False
        self._hey_computer_callback: Optional[
            Callable[[], Coroutine[Any, Any, None]]
        ] = None
        self._stop_there_callback: Optional[Callable[[], Coroutine[Any, Any, None]]] = (
            None
        )
        ...
        self.base_path = os.path.abspath(
            os.path.join(os.path.dirname(__file__), "..", "wakeword", "models")
        )
        ...
        def recognized_cb(evt):
            ...
            if result.reason == speechsdk.ResultReason.RecognizedKeyword:
                ...
                if (
                    ...
                    and not self.stt_enabled
                    and self._hey_computer_callback
                ):
                    print("Triggering hey_computer callback")
                    asyncio.run_coroutine_threadsafe(
                        self._hey_computer_callback(), self._loop
                    )
                ...
                # For "stop there", always trigger
                    ...
                    asyncio.run_coroutine_threadsafe(
                        self._stop_there_callback(), self._loop
                    )
